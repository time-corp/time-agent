        ...
        headerRight={
          selectedChannelIds.length > 0 ? (
            <DeleteConfirmDialog
              ...
              description={`Are you sure you want to delete ${selectedChannelIds.length} channel${selectedChannelIds.length > 1 ? "s" : ""}? This action cannot be undone.`}
              confirmLabel="Delete"
              ...
              trigger={
                ...
                >
                  ...
                  Delete {selectedChannelIds.length} selected
                </Button>
              }
            />
          ) : undefined
